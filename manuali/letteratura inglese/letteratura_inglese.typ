...
= Il Rinascimento e l'età elisabettiana
...
= La fine del Rinascimento e l'età della Restaurazione
...
#pagebreak()
#show: chic.with(skip: ())
Copertina: John Taylor, _Ritratto di William Shakespeare_, 1611, National Portrait Gallery, Londra.
#align(center)[\u{2660}]