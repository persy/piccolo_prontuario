...
Nella notazione vettoriale, un vettore viene indicato con una lettera sormontata da una freccia oppure con una lettera in grassetto, come A. Quando si considera esclusivamente l'intensità del vettore, esso viene trattato come una grandezza scalare, utilizzando il corsivo per la notazione, ad esempio *A*, o direttamente il grassetto, secondo le convenzioni adottate in questo contesto. Seguiranno queste modalità nel corso del trattato per uniformare le diciture e facilitare la comprensione.
---
...
+ **Verso uguale ma direzione diversa:** in questo caso si utilizza la regola del parallelogramma, rappresentata graficamente nella figura 2.2.
