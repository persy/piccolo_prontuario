...
#copertina(
  materia: "Filosofia",
  colore: main_umane,
  immagine: image("_media/Pensatore2.png", width: 60%),
)
...
#pagebreak()
#show: chic.with(skip: ())
Copertina: _Il pensatore di Rodin_, 1880-1902, Musée Rodin, Parigi.
#align(center)[\u{2660}]