...
// Da qui in poi le immagini devono ancora essere inserite
...
#sidenote[#TODO[Da inserire \ Immagine cellula eucariote]]
...
#sidenote[#TODO[Da inserire \ Immagine differenze cellule procariote ed eucariote]]
...
#sidenote[#TODO[Da inserire \ Immagine membrana plasmatica]]
...
=== Lipidi
#sidenote[#TODO[Da inserire \ Immagine lipidi essenziali]]
...
=== Proteine
#sidenote[#TODO[Da inserire \ Immagine proteine essenziali]]
...
=== Carboidrati
#sidenote[#TODO[Da inserire \ Immagine carboidrati essenziali]]
...
== Il nucleo
#sidenote[#TODO[Da inserire \ Immagine nucleo cellulare]]
...
#sidenote[#TODO[Da inserire \ Immagine cromatina e cromosomi]]
...
== Il citoplasma
#sidenote[#TODO[Da inserire \ Immagine citoplasma]]
...
- citoscheletro  
- ciglia e flagelli   
#sidenote[#TODO[Da inserire \ Immagine reticolo endoplasmatico]]
...
Esistono due varianti di reticolo endoplasmatico: quello ruvido, che rappresenta un'estensione della membrana nucleare ed è caratterizzato dalla presenza di milioni di piccoli granuli chiamati ribosomi sulla sua superficie esterna, coinvolti nella sintesi delle proteine, e quello liscio, privo di ribosomi e deputato alla produzione di lipidi. 

Lo spazio racchiuso tra le membrane ripiegate di entrambi i tipi di reticolo endoplasmatico svolge la funzione di deposito e trasferimento di molecole all'interno della cellula.
#sidenote[#TODO[Da inserire \ Immagine ribosomi]]
...
#sidenote[#TODO[Da inserire \ Immagine apparato Golgi]]
...
#sidenote[#TODO[Da inserire \ Immagine lisosomi]]
...
#sidenote[#TODO[Da inserire \ Immagine mitocondri]]
...
#sidenote[#TODO[Da inserire: \ Immagine riproduzione mitocondri]]
...
#sidenote[#TODO[Da inserire: \ Immagine organuli mitocondriali]]
...
#sidenote[#TODO[Da inserire: \ Immagine centrioli e ciglia]]
...
== La cellula vegetale
#sidenote[#TODO[Da inserire: \ Immagine cellula vegetale]]
...
#sidenote[#TODO[Da inserire: \ Immagine differenziamento cellulare]]
...
#wideblock[#TODO[Da inserire: \ Altre immagini struttura cellulare]]
#pagebreak()
== Approfondimento: la teoria cellulare <senza_numero>
...
#wideblock[#TODO[Da inserire: \ Immagine teoria cellulare]]
#pagebreak()
