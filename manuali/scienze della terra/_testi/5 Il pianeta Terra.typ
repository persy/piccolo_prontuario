...
**Anno**  
Periodo necessario alla Terra per completare un'orbita intorno al Sole. A seconda del riferimento usato, può essere un anno sidereo (basato su una stella fissa) o tropico (detto anche solare). Per effetto della precessione degli equinozi, l'anno tropico dura 365 giorni, 5 ore e 46 minuti ed è più corto di circa 20 minuti rispetto al sidereo. Dall'anno tropico deriva l'anno civile di 365 giorni, con l'aggiunta di un giorno ogni quattro anni per formare l'anno bisestile.

**Bussola**  
Strumento per orientarsi geograficamente o navigare, composto da un ago calamitato che ruota su una rosa dei venti e indica costantemente il nord magnetico.

**Crepuscolo**  
Fioca luminosità che precede l'alba o segue il tramonto del Sole.

**Dì**  
Periodo della giornata illuminato dalla luce del Sole. La sua durata varia durante l'anno: è massima al solstizio d'estate e minima al solstizio d'inverno nell'emisfero boreale.

**Ellissoide**  
Superficie tridimensionale generata dalla rotazione di un'ellisse attorno a uno dei suoi assi.

**Equinozio**  
Giornata in cui la durata del giorno e della notte è uguale in ogni punto della Terra.

**Geoide**  
Superficie ideale, perpendicolare alla forza di gravità in ogni suo punto, che riflette le irregolarità nella distribuzione della densità terrestre. Può essere immaginata come la superficie media degli oceani estesa idealmente attraverso i continenti. Il geoide viene usato come riferimento per misurazioni topografiche, altimetriche e marine.

**Giorno**  
Unità di tempo corrispondente a una rotazione completa della Terra su sé stessa.

**Inclinazione**  
Angolo formato dal piano dell'orbita di un corpo celeste rispetto al piano dell'eclittica. L'inclinazione dell'orbita terrestre, nota come obliquità dell'eclittica, è pari a 23°27'.

**Latitudine**  
Distanza angolare di un punto dall'equatore, misurata in gradi e frazioni sul meridiano che passa per quel punto.

**Longitudine**  
Distanza angolare di un punto rispetto al meridiano di riferimento, calcolata sull'arco di parallelo passante per il punto stesso.

**Rosa dei venti**  
Rappresentazione grafica delle direzioni dei venti, corrispondenti ai quattro punti cardinali e alle direzioni intermedie.