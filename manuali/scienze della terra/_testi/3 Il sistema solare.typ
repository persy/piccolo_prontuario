...
// Tabella caratteristiche pianeti
...
Gli studi condotti sia tramite le missioni Apollo che con sonde prive di equipaggio hanno consentito di delineare un modello affidabile della struttura interna lunare. La superficie è ricoperta da uno strato di regolite formato da sabbia e polvere, con un'ampiezza che in alcune aree raggiunge i 20 metri. La crosta lunare ha una profondità media di 60 km, al di sotto della quale si estende il mantello fino a circa 1000 km. Più in profondità si trova l'astenosfera, una zona parzialmente fusa, seguita dal nucleo centrale. Questo nucleo, ricco di ferro e probabilmente liquido, ha un diametro stimato attorno ai 1000 km e una temperatura che si aggira sui 1500 °C. I sismometri posti sul suolo lunare durante varie missioni hanno registrato terremoti sia superficiali che profondi. Le scosse sismiche sono provocate da impatti meteoritici e da movimenti interni della Luna stessa. Questi ultimi si verificano con maggiore frequenza quando la Luna si trova più vicina alla Terra, legati all'influenza gravitazionale esercitata dal nostro pianeta.
...
== Approfondimento: Leggi che governano i moti dei pianeti
...
**Afelio**  
Punto più lontano dal Sole occupato da un pianeta o un corpo celeste lungo la propria orbita ellittica.

**Astronomia**  
Scienza che studia gli astri e i fenomeni dell'universo.

**Baricentro**  
Punto in cui si considera concentrata tutta la massa di un corpo o sistema; chiamato anche centro di gravità o centro di massa.

**Datazione radioattiva**  
Metodo per determinare l'età di rocce o eventi geologici basato sulla misurazione della concentrazione di elementi radioattivi.

**Ellisse**  
Luogo geometrico dei punti del piano in cui la somma delle distanze da due punti fissi, detti fuochi, è costante.

**Ellissoide**  
Solido generato dalla rotazione di un'ellisse attorno a uno dei suoi assi principali.

**Forza centripeta**  
Forza che attrae i corpi verso un centro. Nel caso degli oggetti sulla Terra coincide con la gravità.

**Forza centrifuga**  
Forza apparente che spinge un corpo verso l'esterno quando si trova in rotazione. Sulla Terra è causata dalla sua rotazione.

**Moto convettivo**  
Trasferimento di calore e materia all'interno di un fluido (liquido o gas) dovuto al movimento libero delle particelle che lo compongono.

**Perielio**  
Punto più vicino al Sole raggiunto da un pianeta o corpo celeste lungo la sua orbita ellittica.