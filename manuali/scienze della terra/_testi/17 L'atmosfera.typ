...
#evidenzia[La Terra è circondata da un involucro gassoso, l'atmosfera, che consiste in una complessa miscela di gas, tra cui azoto, ossigeno e diossido di carbonio (anidride carbonica). Questo sistema svolge funzioni di fondamentale importanza sia per l'ambiente fisico terrestre, contribuendo ad esempio al modellamento del pianeta attraverso i fenomeni meteorologici che si verificano al suo interno, sia per gli organismi viventi, dato che l'ossigeno e il diossido di carbonio rappresentano gas indispensabili per la respirazione. 
...
// Tabella composizione atmosfera al suolo
...
Le caratteristiche principali della troposfera possono essere sintetizzate come segue: la composizione chimica risulta costante grazie ai moti orizzontali e verticali dell'aria, che assicurano un continuo rimescolamento dei gas atmosferici; la temperatura diminuisce con l'aumentare dell'altitudine, poiché l'atmosfera viene riscaldata dal calore emesso dalla superficie terrestre. Al livello del suolo, la temperatura media annua è pari a circa 15 °C; tale decremento termico segue un gradiente geotermico verticale di 6,5 °C per chilometro. Inoltre, la pressione atmosferica decresce con l'altezza, poiché, salendo, la colonna d'aria sovrastante diviene progressivamente più ridotta, e gli strati superiori dell'atmosfera si presentano sempre più rarefatti. Nella troposfera si concentra quasi tutta l'acqua presente nell'atmosfera: il vapore acqueo proviene principalmente dall'evaporazione degli oceani, delle acque continentali e dalla traspirazione degli organismi viventi. Questo vapore si accumula prevalentemente nei primi 4 km di altitudine, dove si trova circa il 75% della sua quantità totale.
...
La pressione atmosferica corrisponde al peso esercitato da una colonna d'aria alta quanto l'atmosfera su una superficie di 1 cm². Al livello del mare, a una latitudine di 45° e a una temperatura di 0 °C, essa equivale alla pressione generata da una colonna di mercurio alta 760 mm con un'area di base pari a 1 cm². Per questo motivo, si considera convenzionalmente un valore di 760 mm Hg.
...
Se si assumesse che la Terra fosse immobile e priva di rotazione attorno al proprio asse, con una distribuzione uniforme di continenti e oceani, si potrebbe osservare una circolazione dell'aria nella troposfera limitata alla parte illuminata dai raggi solari e all'emisfero nord. Questo tipo di circolazione atmosferica ideale porterebbe alla formazione di una struttura conosciuta come cella di Hadley, intitolata allo scienziato inglese George Hadley (1685-1768), che nel 1735 cercò di spiegare per la prima volta i fenomeni atmosferici su scala globale. L'effetto del riscaldamento solare sull'Equatore genererebbe correnti ascensionali di aria calda, che si solleverebbero verso altitudini elevate nella troposfera, dove si divergerebbero in direzione dei Poli Nord e Sud, seguendo il tracciato dei meridiani. Via via che queste correnti si spostano verso i poli, l'aria tende a raffreddarsi progressivamente, chiudendo infine il ciclo e tornando verso l'Equatore come masse di aria fredda.
...
Le nubi possono essere catalogate in base alla loro altitudine e al loro aspetto morfologico.  

In riferimento alla quota alla quale si originano, è possibile distinguere:  
...
== Approfondimento: l'ozonosfera e il buco nell'ozono
...
== Approfondimento: l'effetto serra
...
== Approfondimento: la forza di Coriolis
...
== Approfondimento: i venti periodici, monsoni e brezze
...
== Approfondimento: il flusso energetico dal Sole alla Terra
...
**Anticiclone**  
Zona caratterizzata da alta pressione atmosferica, delimitata da isobare chiuse con valori di pressione che diminuiscono progressivamente dal centro verso la periferia.  

**Aurora polare**  
Fenomeno luminoso che si osserva nella ionosfera sotto forma di archi e raggi colorati, tipico delle aree polari e circumpolari. È causato dall'urto ad alta velocità tra corpuscoli solari e particelle ionizzate presenti nell'atmosfera superiore della Terra.  

**Ciclone**  
Regione di bassa pressione atmosferica delimitata da isobare chiuse, con valori di pressione che aumentano dal centro verso la periferia. Anche definito come flusso d'aria vorticoso attorno a un centro di bassa pressione.  

**Clorofluorocarburi (CFC)**  
Composti organici contenenti cloro e fluoro, utilizzati principalmente come fluidi refrigeranti e propellenti per aerosol. Sono responsabili della significativa riduzione dell'ozono stratosferico.  

**Effetto di Coriolis**  
Fenomeno fisico che provoca un'apparente deviazione del movimento di un corpo libero su una superficie rotante, verso destra o sinistra a seconda della direzione del moto.  

**Ionosfera**  
Regione atmosferica composta da strati d'aria ionizzati ben definiti, situata a partire da quote comprese tra 60 e 80 km, includendo mesosfera e termosfera.  

**Nube**  
Aggregazione visibile di piccole gocce d'acqua o cristalli di ghiaccio sospesi nell'atmosfera. Si forma grazie alla condensazione del vapore acqueo attorno a particelle o ioni che fungono da nuclei di condensazione.  

**Ozono**  
Forma triatomica dell'ossigeno (O3), meno comune rispetto alla tradizionale forma biatomica (O2). La concentrazione massima di ozono si trova nella regione dell'ozonosfera.  

**Sublimazione**  
Passaggio diretto di una sostanza dallo stato solido a quello aeriforme senza attraversare la fase liquida.  
