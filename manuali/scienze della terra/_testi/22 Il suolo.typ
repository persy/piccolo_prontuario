...
La scienza che si occupa dello studio dei suoli nei loro aspetti compositivi, evolutivi e genetici è la pedologia. Essa analizza i complessi processi della pedogenesi e valuta l'interazione dei diversi fattori ambientali coinvolti nella formazione e sviluppo dei suoli.
...
- Orizzonte A: è la parte più ricca di sostanza organica, dove si svolge un'intensa attività di decomposizione. Questo strato è indicato come orizzonte eluviale poiché l'acqua infiltrata nel suolo vi provoca l'asportazione dei componenti solubili, inorganici e organici, trasferendoli nell'orizzonte sottostante. Può essere ulteriormente suddiviso nei sottorizzonti A1, A2 e A3, ciascuno con caratteristiche specifiche.
- Orizzonte B: è più povero di humus rispetto all'orizzonte A ed è chiamato orizzonte illuviale, poiché in esso si accumulano i materiali provenienti dall'orizzonte superiore trasportati dall'acqua. Anche questo orizzonte può essere suddiviso in sottorizzonti B1, B2 e B3.
- Orizzonte C: costituisce lo strato più profondo del suolo ed è composto dalla roccia in via di alterazione. In quest'orizzonte può comparire uno strato sottile di colore grigio, verdastro o rossiccio, formato da minerali di ferro combinati con argilla, denominato gley. I sottorizzonti C1 indicano le aree dove la degradazione della roccia è più avanzata, mentre i sottorizzonti C2 sono caratterizzati da un minor grado di alterazione.
...
== Approfondimento: la potenzialità dei suoli
...
Detrito  
Frammento di materiale roccioso derivante dalla disgregazione delle rocce a opera di agenti naturali.  

Humus  
Insieme di sostanze organiche contenute nel terreno, prodotte dalla decomposizione dei resti di organismi vegetali e animali.  

Orizzonte  
Ciascun livello stratificato del suolo, differente per composizione e colore.  

Pedologia  
Scienza che analizza la formazione, le caratteristiche e l'evoluzione dei suoli.  

Permafrost  
Strato di terreno perennemente ghiacciato presente nelle regioni polari.  

Porosità  
Caratteristica del suolo che misura il grado di presenza di pori e interstizi, espressa come il rapporto tra il volume degli spazi vuoti e il volume totale del suolo.  

Potenzialità  
Proprietà di un suolo che indica le possibilità di uso, soprattutto in ambito agricolo e forestale.  

Profilo pedologico  
Sequenza dei vari orizzonti che compongono il suolo.  

Scheletro  
Componente minerale del suolo formata da granuli con un diametro superiore ai 2 mm.  

Tessitura  
Proprietà del suolo che descrive la proporzione di scheletro, sabbia, limo e argilla presenti.  
