...
I calcari e le dolomie si formano rispettivamente dalla precipitazione del carbonato di calcio (CaCO3) e del carbonato doppio di calcio e magnesio (CaMg(CO3)2), presenti nelle acque di mari caratterizzati da bassi fondali e temperature elevate, in seguito a una forte evaporazione.
...
Le evaporiti, invece, derivano dalla precipitazione di sali disciolti in acque marine divenute sature per intensa evaporazione. L'ordine di precipitazione dei sali dipende dalla loro solubilità: si depositano dapprima quelli meno solubili, come calcite (CaCO3) e dolomite (CaMg(CO3)2), seguiti via via dagli altri, sino ai più solubili, quali gesso (CaSO4·2H2O), anidrite (CaSO4) e salgemma (NaCl).

Le selci, infine, si formano da un deposito di microscopici cristalli di quarzo (SiO2) derivanti dalla precipitazione della silice. Sono rocce estremamente dure, spesso composte da noduli globosi di quarzo con diametri che variano da pochi centimetri a decimetri. Nell'età della pietra, frammenti di selci venivano utilizzati dall'uomo per la fabbricazione di strumenti. Un particolare deposito di silice si verifica in ambiente continentale; qui, a partire da acque calde di origine vulcanica, si genera la geyserite per precipitazione di SiO2.
...
== Approfondimento: la formazione del carbone fossile
...
== Approfondimento: l'azione degli organismi viventi sulle rocce
...
== Approfondimento: gli ambienti di sedimentazione
...
**Arenaria**  
Roccia sedimentaria costituita da granuli di sabbia legati tra loro da un cemento composto da calcio, argilla o silice.  

**Argilla**  
Roccia sedimentaria costituita principalmente da silicato idrato di alluminio mescolato ad altri minerali. Quando bagnata, diventa estremamente malleabile e conserva la forma dopo cottura o essiccazione.  

**Breccia**  
Roccia sedimentaria clastica composta da frammenti angolosi con diametro superiore a 2 mm.  

**Calcare**  
Roccia sedimentaria di origine chimica o organogena composta per oltre il 50% da carbonato di calcio sotto forma di calcite.  

**Carbone**  
Materiale solido combustibile, ricco di carbonio (grafite), che brucia con una reazione altamente esotermica. Si forma dalla lenta trasformazione di residui vegetali coperti da strati sedimentari.  

**Clasti**  
Frammenti di rocce derivanti dalla disgregazione causata da agenti atmosferici.  

**Diagenesi**  
Serie di processi chimico-fisici che avvengono nei sedimenti tra i minerali o tra questi e le soluzioni circolanti, dalla deposizione fino alla formazione della roccia solida.  

**Facies**  
Insieme delle caratteristiche litologiche e paleontologiche che permettono di individuare l'origine ambientale di una roccia.  

**Sedimentazione**  
Processo di deposizione e accumulo di materiali sulla superficie terrestre, sia in ambiente subaereo che subacqueo. Può avvenire per via meccanica, chimica o organogena.  

**Stratificazione**  
Caratteristica delle rocce sedimentarie che consiste nella sovrapposizione di superfici piane e parallele, creando strati distinti nella massa rocciosa.  

**Tufo**  
Roccia piroclastica originata dalla sedimentazione di materiali espulsi durante eruzioni vulcaniche esplosive, in ambiente terrestre o acquatico.  