...
In sintesi, la composizione mineralogica finale di una roccia metamorfica dipende sia dall'intensità del processo metamorfico che dalla sua composizione chimica iniziale.
...
== Approfondimento: gli effetti del metamorfismo sulle rocce
...
**Anatessi**  
Processo di fusione parziale che interessa una massa rocciosa preesistente.  

**Gneiss**  
Roccia metamorfica con struttura scistosa, generatasi tramite metamorfismo regionale di origine ignea o sedimentaria.  

**Marmo**  
Roccia con tessitura granulare, derivante dal metamorfismo di contatto del calcare.  

**Metamorfismo**  
Fenomeno di trasformazione di una roccia preesistente, caratterizzato da reazioni allo stato solido fra i minerali che la costituiscono, comportando modificazioni della composizione mineralogica e/o della struttura originaria.  

**Milonite**  
Roccia metamorfica sviluppatasi attraverso un processo di fine frantumazione, seguito da ricristallizzazione, dei componenti di una roccia preesistente.  

**Scistosità**  
Caratteristica delle rocce metamorfiche che consente la loro suddivisione in lastre sottili lungo piani paralleli definiti piani di scistosità.  

**Tessitura**  
Configurazione visibile, anche macroscopicamente, di una roccia, determinata dalla disposizione spaziale dei suoi costituenti mineralogici.  