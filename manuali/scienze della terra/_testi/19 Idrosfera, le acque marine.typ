...
// Sali in un 1kg di acqua marina
...
== Approfondimento: La morfologia dei fondali oceanici
...
== Approfondimento: i sedimenti marini
...
Circuito oceanico  
Movimento ciclico delle masse d'acqua marine, il cui spostamento, determinato da una sequenza di correnti, forma percorsi chiusi e ricorrenti all'interno di uno stesso bacino oceanico.

Corrente oceanica o marina  
Flusso di acqua che si muove all'interno di un oceano o di un mare seguendo una specifica direzione.

Corrente termoalina  
Corrente marina caratterizzata da uno spostamento estremamente lento sul fondale oceanico, concepito per bilanciare le variazioni di temperatura e salinità presenti alle diverse latitudini di un unico oceano.

Frangente  
Onda marina la cui cresta si rompe creando un movimento spumeggiante sulla superficie dell'acqua.

Marea  
Movimento periodico di risalita e abbassamento del livello delle acque marine causato dall'attrazione gravitazionale esercitata dalla Luna e dal Sole sulla Terra.

Moto ondoso  
Oscillazione che coinvolge le particelle d'acqua superficiali in una determinata massa liquida.

Onda  
Movimento irregolare delle acque marine o lacustri generato dall'azione del vento.

Regressione  
Fenomeno di ritiro delle acque marine dalla terraferma, derivante da un abbassamento del livello degli oceani o da un innalzamento delle terre emerse.

Termoclino  
Zona compresa tra i 200 e i 1000 metri di profondità caratterizzata da una graduale diminuzione della temperatura. Questo strato separa le acque superficiali da quelle profonde.

Trasgressione  
Fenomeno con cui il mare invade territori precedentemente emersi.
