...
#copertina(
  ...
  immagine: image("_media/Patrizio_Torliona.png", width: 60%),
)
...
= La prosa di Svetonio, Floro, Frontone, Gellio
...
#pagebreak()
#show: chic.with(skip: ())
Copertina: Particolare del _Patrizio Torlonia_, busto identificato con Catone il Censore, I sec. a.C., Collezione Torlonia, Roma.
#align(center)[\u{2660}]