...
#copertina(
  ...
  immagine: image("_media/Leopardi.png", width: 60%),
)
...
#include "_testi/9 Il Novecento/1 Al di là del decadentismo.typ"

= Benedetto Croce e il dibattito critico

#include "_testi/9 Il Novecento/2 Benedetto Croce e il dibattito critico.typ"

= Luigi Pirandello

#include "_testi/9 Il Novecento/3 Luigi Pirandello.typ"

= Italo Svevo

#include "_testi/9 Il Novecento/4 Italo Svevo.typ"

= La nuova poesia, Saba e Ungaretti

#include "_testi/9 Il Novecento/5 La nuova poesia, Saba e Ungaretti.typ"

= Gli anni Venti e Trenta

#include "_testi/9 Il Novecento/6 Gli anni Venti e Trenta.typ"

= Surrealismo e realismo

#include "_testi/9 Il Novecento/7 Surrealismo e realismo.typ"

= L'ermetismo

#include "_testi/9 Il Novecento/8 L'ermetismo.typ"

= Eugenio Montale

#include "_testi/9 Il Novecento/9 Eugenio Montale.typ"

= Carlo Emilio Gadda

#include "_testi/9 Il Novecento/10 Carlo Emilio Gadda.typ"

= Il neorealismo

#include "_testi/9 Il Novecento/11 Il neorealismo.typ"

= Il realismo critico

#include "_testi/9 Il Novecento/12 Il realismo critico.typ"

= La poesia dialettale del Novecento

#include "_testi/9 Il Novecento/13 La poesia dialettale del Novecento.typ"

= La poesia del dopoguerra

#include "_testi/9 Il Novecento/14 La poesia del dopoguerra.typ"

= Sperimentalismo e neoavanguardia

#include "_testi/9 Il Novecento/15 Sperimentalismo e neoavanguardia.typ"

= Elsa Morante e le narratrici

#include "_testi/9 Il Novecento/16 Elsa Morante e le narratrici.typ"

= Italo Calvino

#include "_testi/9 Il Novecento/17 Italo Calvino.typ"

= Gli ultimi decenni del Novecento

#include "_testi/9 Il Novecento/18 Gli ultimi decenni del Novecento.typ"
...
#pagebreak()
#show: chic.with(skip: ())
Copertina: Stanislao Ferrazzi, _Ritratto di Giacomo Leopardi_, 1897, Casa Leopardi, Recanati
#align(center)[\u{2660}]
