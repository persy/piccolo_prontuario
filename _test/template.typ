...
#let definizione(title: none, label: none, ..sections) = context {
  ...
  let box-content = {
    let args = (
      frame: (border-accent: accent.lighten(20%), title-accent: accent.lighten(80%), body-accent: accent.lighten(95%), radius: (top-right: 5pt, rest: 0pt), thickness: (left: 1pt)),
      title-style: (accent: accent.darken(40%), weight: "bold", sep-thickness: 0pt),
      body-style: (accent: accent.darken(50%)),    
      sep: (thickness: 0.5pt, dash: "dashed", accent: accent.lighten(20%)),
      breakable: true,
    )
    let display-title = {      
...
#let esempio(title: "Esempio", ..sections) = context {
  ...
  showybox(
    frame: (border-accent: accent.darken(40%), title-accent: accent.lighten(65%), body-accent: accent.lighten(90%), radius: (top-right: 5pt, rest: 0pt), thickness: (left: 1pt)),
    title-style: (accent: accent.darken(70%), weight: "bold", sep-thickness: 0pt, size: 0.8em),
    body-style: (accent: accent.darken(70%)),
    sep: (thickness: 0.5pt, dash: "dashed", accent: accent.darken(20%)),
    breakable: true,
